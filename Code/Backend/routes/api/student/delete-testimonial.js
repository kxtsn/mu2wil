...
router.post('/', isLoggedIn, async function (req, res, next) {
    ...
    if (req.userData["role"] == 3 || req.userData["role"] == 1) {
        ...
        try {
            ...
            const mresult = await conn.query(`UPDATE student_testimonial SET Status = 'Deleted' WHERE Student_Testimonial_ID = ${pool.escape(req.body.testimonialId)}`)
